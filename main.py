...
def recommend():
    ...
    # retrieve movie suggestions for an autocomplete feature
    suggestions = get_suggestions()
    ...
    if(imdb_id != ""):
        ...
        reviews_status = [] # list of review status (good/bad)
        for reviews in soup_result:
            if reviews.string:
                reviews_list.append(reviews.string)
                # pass the review to our model
        ...
        # pass all the data to the html file if the users want to implement front-end
        return render_template('movies.html',title=title,poster=poster,overview=overview,vote_average=vote_average,
